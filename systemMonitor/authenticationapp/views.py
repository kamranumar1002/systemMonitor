...
def systemDetail(request, id):
    ...
    average_ram_bnc_id = TblBenchmark.objects.get(bnc_process="average_ram_usage").bnc_id

    # Getting benchmark id of average cpu value 
    average_cpu_bnc_id = TblBenchmark.objects.get(bnc_process="average_cpu_usage").bnc_id
